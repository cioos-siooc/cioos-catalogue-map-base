...
export default function DrawerExample() {
  ...
  return (
    ...
    <div>
        <div>
            <div className="">
                <h5 id="drawer-navigation-label" className="pl-5 pb-5 pt-5 bg-white w-76 dark:bg-gray-800 text-base font-semibold text-gray-500 uppercase dark:text-gray-400">Liste de jeux de données</h5>
            ...
            <div id="drawer-navigation" className={`top-0 z-70 h-screen py-4 overflow-y-auto bg-white w-76 dark:bg-gray-800" ${
