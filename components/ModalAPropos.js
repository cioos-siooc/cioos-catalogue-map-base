      ...
      <Modal dismissible show={openModal} onClose={() => setOpenModal(false)} >
        ...
        <ModalBody>
          <p className="space-y-6 text-base leading-relaxed">
              ...
              par variable océanique* tels que la température de surface de
              l’eau ou le phytoplancton. En cliquant sur les points de données
              et leur étendue géospatiale, le panneau latéral affiche les
