      ...
      {citationHtml && (
        <div className="space-y-2 py-3">
          ...
          <a
            ...
            className="group bg-background-light hover:bg-primary-100 dark:bg-background-dark dark:hover:bg-primary-700 flex items-start gap-2 rounded-md p-3 text-xs transition-colors"
          >
